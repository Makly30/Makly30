...
$sql="SELECT menu.menu_id,menu.menu_name,type1.t_name,size.s_name,menu.price,menu.menu_pic from menu join type1 on menu.menu_type=type1.t_id join size on menu.menu_size=size.s_id;";
$result=mysqli_query($conn,$sql);
...
<!---<a href="order_add.php?menu_id=<?php// echo $row['menu_id'];?>" class="btn btn-warning">Order</a>-->
<a href="menu_edit.php?menu_id=<?php echo $row['menu_id'];?>" class="btn btn-warning">Edit</a>
<!--<a href="photoshow.php?menu_id=<?php //echo $row['menu_id'];?>" class="btn btn-info">ใส่ภาพ</a>-->
<a href="menu_delete.php?menu_id=<?php echo $row['menu_id'];?>" class="btn btn-danger">Delete</a>
</div>
  </div>
</div>
<?php
