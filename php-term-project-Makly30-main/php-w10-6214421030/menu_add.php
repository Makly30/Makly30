      ...
      <div class="col-sm-12 col-md-9 col-lg-9">
                ...
                <?php
                    if(isset($_GET['submit'])){
                        ...
                        $price=$_GET['price'];
                        $sql = "insert into menu (menu_name,menu_type,menu_size,price,menu_pic)";
                        $sql .=" values ('$menu_name','$menu_type','$menu_size','$price','')";
                        //echo $sql;
                        include 'connectdb.php';
                        mysqli_query($conn,$sql);
                        mysqli_close($conn);
                        echo "เพิ่มMenu $menu_name เรียบร้อยแล้ว<br>";
                        echo '<a href="menu_admin.php">แสดงMenuทั้งหมด</a>';
                    }else{
                ?>
                    <form class="form-horizontal" role="form" name="menu_add" action="<?php echo $_SERVER['PHP_SELF']?>">
                        ...
                        <label for="menu_type" class="col-md-2 col-lg-2 control-label">ประเภทเมนู</label>
                        <div class="col-md-10 col-lg-10">
                           ...
                           <label for="menu_size" class="col-md-2 col-lg-2 control-label">ขนาด</label>
                        <div class="col-md-10 col-lg-10">
                                <select name="menu_size" id="menu_size" class="form-control">
                                <?php
                                    include 'connectdb.php';
