...
<div class="jumbotron" style="background-color:#fdebd0;color:#21618c">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="col-sm-12 col-md-9 col-lg-9">
             <h5 class='text-success'><b>   Welcome to Admin Page! </b></h5>
               ...
               <td><?php echo $objResult["cus_fname"].' '.$objResult["cus_lname"];?></td>
                </tr>
                </table>
  ...
  <span class="label label-warning "><a href="edit_profile2.php" >Edit Profile</a></span>
