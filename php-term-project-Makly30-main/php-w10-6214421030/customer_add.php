      ...
      <div class="col-sm-12 col-md-9 col-lg-9">
                ...
                <?php
                    if(isset($_GET['submit'])){
                        ...
                        $sql = "insert into customer (cus_fname,cus_lname,cus_phone,cus_address)";
                        $sql .="values ('$cus_fname','$cus_lname','$cus_phone','$cus_address')";
                        echo $sql;
                        include 'connectdb.php';
                        mysqli_query($conn,$sql);
                        mysqli_close($conn);
                        echo "เพิ่มลูกค้า $cus_fname $cus_lname เรียบร้อยแล้ว<br>";
                    ...
                    <form class="form-horizontal" role="form" name="cus_add" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-lg-10">
                                <input type="text" name="cus_fname" id="cus_fname" class="form-control">
                            </div>    
                        </div>
                        <div class="form-group">
                            <label for="cus_lname" class="col-md-2 col-lg-2 control-label">นามสกุล</label>
                            <div class="col-md-10 col-lg-10">
                                <input type="text" name="cus_lname" id="cus_lname" class="form-control">
                            </div>    
                        </div>  
                         <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="cus_address" class="col-md-2 col-lg-2 control-label">ที่อยู่</label>
                            <div class="col-md-10 col-lg-10"> 
