  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="container">
                    ...
                    <h2>โปรโมชั่น</h2>
                    <a href="promotion_add.php" class="btn btn-link">เพิ่ม</a>
      ...
      <?php
    include "connectdb.php";
    $sql="SELECT pro_id,pro_name,pro_condition,pro_discount,deadline FROM `promotion` order by pro_id ";
    ...
    while (($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) != NULL) {
        ...
        echo '<td>'?><a href="promotion_edit.php?pro_id=<?php echo $row['pro_id'];?>" class="btn btn-warning">แก้ไข</a>
                                      <a href="JavaScript:if(confirm('ยืนยันการลบ')==true){window.location='promotion_delete.php?pro_id=<?php echo $row["pro_id"];?>'}" class="btn btn-danger">ลบ</a>   
                                      <?php
                                    echo '</td>';
                                    echo '</tr>';
                                }
