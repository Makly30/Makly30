...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2021 at 08:14 AM
...
--
-- Table structure for table `customer_deliver`
--

DROP TABLE IF EXISTS `customer_deliver`;
CREATE TABLE `customer_deliver` (
  `cu_id` int(11) NOT NULL,
  `cus_name` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `customer_deliver`
--

INSERT INTO `customer_deliver` (`cu_id`, `cus_name`) VALUES
(1, 'ส่งภายนอกจังหวัดว่างขาย'),
(2, 'ส่งภายในจังหวัดว่างขาย');

-- --------------------------------------------------------

--
-- Table structure for table `deliver_active`
--

DROP TABLE IF EXISTS `deliver_active`;
CREATE TABLE `deliver_active` (
  `d_a_id` int(11) NOT NULL,
  `d_a_name` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `deliver_active`
--

INSERT INTO `deliver_active` (`d_a_id`, `d_a_name`) VALUES
(1, 'Not available'),
(2, 'available');
...
--
-- Table structure for table `deliver_choices`
--

DROP TABLE IF EXISTS `deliver_choices`;
CREATE TABLE `deliver_choices` (
  `d_ch_int` int(11) NOT NULL,
  `d_ch_active` int(11) DEFAULT NULL,
  `d_ch_date` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `deli_start` int(11) NOT NULL,
  `deli_stop` int(11) NOT NULL,
  `deli_time` int(11) NOT NULL,
  `deli_deliver_id` int(11) NOT NULL,
  `deli_avtime_from` datetime NOT NULL,
  `deli_avtime_to` datetime NOT NULL,
  `deli_pic` varchar(255) NOT NULL,
  `deli_price` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `deliver_choices`
--

INSERT INTO `deliver_choices` (`d_ch_int`, `d_ch_active`, `d_ch_date`, `deli_start`, `deli_stop`, `deli_time`, `deli_deliver_id`, `deli_avtime_from`, `deli_avtime_to`, `deli_pic`, `deli_price`) VALUES
(1, 2, '2021-08-14 06:31:57', 13, 1, 5, 3, '2021-08-08 07:30:00', '2021-08-08 12:30:00', 'Screen-Shot-2016-11-30-at-9.00.33-PM.png', 120),
(2, 2, '2021-08-14 06:38:31', 13, 12, 4, 3, '2021-08-10 07:00:00', '2021-08-10 11:00:00', 'Screen-Shot-2016-11-30-at-9.00.33-PM.png', 90),
(4, 2, '2021-08-14 13:51:20', 2, 11, 6, 6, '2021-08-15 07:50:00', '2021-08-14 13:51:00', '360_F_130648163_zLEs0gxg4j7tGDV8PQqxzjeJmiIF4tFu.jpg', 79),
(5, 2, '2021-08-14 14:16:43', 1, 1, 3, 6, '2021-08-15 09:15:00', '2021-08-14 12:15:00', '115480730037kxvtfhwuickclsixb1obc5sgstiwuo6dui6j2bmyb2kpzwr3jcnjl5s4jvlri9rrwxyfqlubqnetwcvusyfrliinve6hybyfzq1.jpg', 55);

-- --------------------------------------------------------

--
-- Table structure for table `deliver_list`
--

DROP TABLE IF EXISTS `deliver_list`;
CREATE TABLE `deliver_list` (
  `dl_id` int(11) NOT NULL,
  `dl_s_id` int(11) DEFAULT NULL,
  `dl_deli_id` int(11) DEFAULT NULL,
  `dl_orp_id` int(11) DEFAULT NULL,
  `dl_datetime` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `dl_dc_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `deliver_list`
--

INSERT INTO `deliver_list` (`dl_id`, `dl_s_id`, `dl_deli_id`, `dl_orp_id`, `dl_datetime`, `dl_dc_id`) VALUES
(1, 1, 3, 1, '2021-08-14 07:42:00', 1),
(2, 1, 3, 2, '2021-08-14 07:42:15', 1),
(3, 1, 3, 3, '2021-08-14 07:42:31', 1),
(6, 1, 6, 7, '2021-08-14 14:00:13', 4),
(7, 7, 6, 8, '2021-08-14 14:17:37', 5);
...
,`customer` varchar(20)
,`orp_amount` int(11)
,`orp_datetime` timestamp
,`total` decimal(21,2)
,`deliver_price` decimal(5,2)
,`total_price` decimal(22,2)
,`seller_id` int(11)
);
...
CREATE TABLE `order_product` (
  ...
  `orp_pr_id` int(11) DEFAULT NULL,
  `orp_cus_id` int(11) DEFAULT NULL,
  `orp_amount` int(11) DEFAULT NULL,
  `orp_tr_id` int(11) NOT NULL,
  `orp_datetime` timestamp NOT NULL DEFAULT current_timestamp(),
  `orp_dc` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `order_product` (`orp_id`, `orp_pr_id`, `orp_cus_id`, `orp_amount`, `orp_tr_id`, `orp_datetime`, `orp_dc`) VALUES
(1, 1, 2, 50, 1, '2021-08-06 15:19:22', 1),
(2, 1, 2, 52, 2, '2021-08-08 17:12:47', 1),
(3, 1, 2, 24, 3, '2021-08-14 04:11:13', 1),
(4, 1, 2, 15, 0, '2021-08-14 10:08:19', 1),
(7, 1, 5, 34, 6, '2021-08-14 13:59:37', 1),
(8, 5, 2, 5, 7, '2021-08-14 14:13:44', 2),
(9, 5, 5, 10, 0, '2021-08-14 14:14:19', 1);
...
CREATE TABLE `products` (
  ...
  `product_measure` decimal(5,2) NOT NULL,
  `product_price` decimal(8,2) DEFAULT NULL,
  `product_amount` int(11) DEFAULT NULL,
  `product_deli_price` decimal(5,2) DEFAULT NULL,
  `product_deli_price_out` decimal(5,2) DEFAULT NULL,
  `product_start` datetime DEFAULT NULL,
  `product_stop` datetime NOT NULL,
  `product_pic` varchar(255) DEFAULT NULL,
  `product_owner` int(11) DEFAULT NULL,
  `product_arrivetime_in` int(11) DEFAULT NULL,
  `product_arrivetime_out` int(11) DEFAULT NULL,
  `product_from` int(5) NOT NULL,
  `product_available_p` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `products` (`product_id`, `product_name`, `product_measure`, `product_price`, `product_amount`, `product_deli_price`, `product_deli_price_out`, `product_start`, `product_stop`, `product_pic`, `product_owner`, `product_arrivetime_in`, `product_arrivetime_out`, `product_from`, `product_available_p`) VALUES
(1, 'cabbage', '1.00', '40.00', 1000, '56.00', '156.00', '2021-08-07 22:06:00', '2021-08-13 22:06:00', 'cabbage.jpg', 1, 2, 4, 13, 'จันทบุรี  กรุงเทพ  ตราด'),
(2, 'Cucumber', '0.50', '15.00', 500, '55.00', '125.00', '2021-08-15 19:03:00', '2021-08-22 19:03:00', 'ShotType1_540x540.jpg', 1, 1, 4, 13, 'กรุงเทพ จันทบุรี '),
(3, 'Cucumber', '0.50', '10.00', 1000, '75.00', '150.00', '2021-08-12 20:32:00', '2021-08-19 20:32:00', 'ecdb7f75-31dd-47bb-8fc8-74a8f823d559--cucumbers-getty.jpg', 4, 2, 5, 2, 'ทุกจังหวัด'),
(5, 'Spinach', '0.10', '25.00', 150, '75.00', '150.00', '2021-08-14 14:12:00', '2021-08-28 21:12:00', 'spinach_620x350_81477995047.png', 7, 2, 6, 1, 'all');
...
INSERT INTO `status_process` (`status_id`, `status_name`) VALUES
(1, 'กำลังจัดสินค้า'),
(2, 'กำลังส่ง'),
(3, 'ถึงลูกค้า');
...
CREATE TABLE `tracking` (
  ...
  `tr_place` varchar(255) DEFAULT NULL,
  `tr_de_list_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tracking` (`tr_id`, `orp_id`, `ps_id`, `tr_place`, `tr_de_list_id`) VALUES
(0, NULL, 1, 'ยังไม่ได้ส่ง', NULL),
(1, 1, 3, 'ต ปทุมวัน อ เขตปทุมวัน จ กรุงเทพมหานคร', 1),
(2, 2, 2, 'Ban Bueng District\r\nChon Buri 20220', 2),
(3, 3, 2, 'Ban Bueng District\r\nChon Buri 20220', 3),
(6, 7, 2, 'samut praka', 6),
(7, 8, 2, NULL, 7);
...
CREATE TABLE `user` (
  ...
  `status` enum('seller','customer','deliver') NOT NULL,
  `user_password` varchar(20) DEFAULT NULL,
  `user_picture` varchar(255) NOT NULL,
  `user_province` int(11) NOT NULL,
  `user_amphur` int(11) NOT NULL,
  `user_commune` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `user` (`user_id`, `user_username`, `user_fname`, `user_lname`, `user_phone`, `user_email`, `user_address`, `status`, `user_password`, `user_picture`, `user_province`, `user_amphur`, `user_commune`) VALUES
(1, 'Market001', 'Market', '001', '0660018286', 'Market001@vegetable.estore', 'ต.ท่าช้าง อ.เมืองจันทบุรี จ.จันทบุรี 22000', 'seller', '123', 'seller-woman-in-a-farmer-market-vector-26571266.jpg', 13, 160, '220106'),
(2, 'Customer001', 'customer', '001', '0660018286', 'customer001@vegetable.estore', 'ต ปทุมวัน อ เขตปทุมวัน จ กรุงเทพมหานคร ', 'customer', '123', 'maxresdefault.jpg', 1, 7, '100703'),
(3, 'deliver001', 'deliver', '001', '0660018286', 'deliver001@vegetable.estore', 'ท่าช้าง เมืองจันทบุรี จันทบุรี 22000', 'deliver', '123', 'fresh-food-delivery-van-cartoon-representing-funny-green-driven-friendly-man-cheering-vegetables-fruit-93400662.jpg', 13, 160, '220106'),
(5, 'Customer002', 'customer', '002', '0660018286', 'customer002@vegetable.estore', 'ต แสนสุข อ เมื่องชลบุรี จ ชลบุรี ', 'customer', '123', '132969547-woman-with-cart-vector-illustration-trolley-full-of-healthy-food-flat-clipart-cartoon-character-groc.jpg', 11, 136, '200104'),
(6, 'deliver002', 'deliver', '002', '0660018286', 'deliver002@vegetable.estore', 'ต บ้านประกาศ อ บางบ่อ จ สมุทรปราการ', 'deliver', '123', 'download.png', 2, 53, '110202'),
(7, 'Market002', 'Market', '002', '0660018286', 'Market002@vegetable.estore', ' สีลม เขต บางรัก กรุงเทพมหานคร', 'seller', '123', 'seller-woman-farm-products-harvest-vector-26568237.jpg', 1, 4, '100402');
...
DROP VIEW IF EXISTS `order_detail`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `order_detail`  AS SELECT `a`.`orp_id` AS `orp_id`, `p`.`product_name` AS `product_name`, `u`.`user_username` AS `owner`, `k`.`user_username` AS `customer`, `a`.`orp_amount` AS `orp_amount`, `a`.`orp_datetime` AS `orp_datetime`, round(`a`.`orp_amount` / `p`.`product_measure` * `p`.`product_price`,2) AS `total`, if(`customer_deliver`.`cu_id` = 2,`p`.`product_deli_price`,`p`.`product_deli_price_out`) AS `deliver_price`, if(`customer_deliver`.`cu_id` = 2,round(`a`.`orp_amount` / `p`.`product_measure` * `p`.`product_price` + `p`.`product_deli_price`,2),round(`a`.`orp_amount` / `p`.`product_measure` * `p`.`product_price` + `p`.`product_deli_price_out`,2)) AS `total_price`, `u`.`user_id` AS `seller_id` FROM (((((((`order_product` `a` join `products` `p` on(`a`.`orp_pr_id` = `p`.`product_id`)) join `user` `u` on(`p`.`product_owner` = `u`.`user_id`)) join `province` `pr` on(`p`.`product_from` = `pr`.`PROVINCE_ID`)) join `user` `k` on(`a`.`orp_cus_id` = `k`.`user_id`)) join `tracking` on(`a`.`orp_tr_id` = `tracking`.`tr_id`)) join `status_process` on(`tracking`.`ps_id` = `status_process`.`status_id`)) join `customer_deliver` on(`a`.`orp_dc` = `customer_deliver`.`cu_id`)) WHERE `a`.`orp_id` <> 0 ;
...
--
-- Indexes for table `customer_deliver`
--
ALTER TABLE `customer_deliver`
  ADD PRIMARY KEY (`cu_id`);

--
-- Indexes for table `deliver_active`
--
ALTER TABLE `deliver_active`
  ADD PRIMARY KEY (`d_a_id`);

--
-- Indexes for table `deliver_choices`
--
ALTER TABLE `deliver_choices`
  ADD PRIMARY KEY (`d_ch_int`),
  ADD KEY `fk_activate` (`d_ch_active`),
  ADD KEY `fk_deliver` (`deli_deliver_id`);

--
-- Indexes for table `deliver_list`
--
ALTER TABLE `deliver_list`
...
ALTER TABLE `order_product`
  ...
  ADD KEY `fk_cus` (`orp_cus_id`),
  ADD KEY `fk_product` (`orp_pr_id`),
  ADD KEY `fk_dc` (`orp_dc`),
  ADD KEY `fk_tracking` (`orp_tr_id`);
...
ALTER TABLE `products`
  ...
  ADD KEY `fk_seller` (`product_owner`);
...
ALTER TABLE `tracking`
  ...
  ADD KEY `fk_order_process` (`orp_id`),
  ADD KEY `fk_deli_list` (`tr_de_list_id`),
  ADD KEY `fk_status` (`ps_id`);
...
--
-- AUTO_INCREMENT for table `customer_deliver`
--
ALTER TABLE `customer_deliver`
  MODIFY `cu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `deliver_active`
--
ALTER TABLE `deliver_active`
  MODIFY `d_a_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `deliver_choices`
--
ALTER TABLE `deliver_choices`
  MODIFY `d_ch_int` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `deliver_list`
--
ALTER TABLE `deliver_list`
  MODIFY `dl_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `order_product`
  MODIFY `orp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
-- Constraints for table `deliver_choices`
--
ALTER TABLE `deliver_choices`
  ADD CONSTRAINT `fk_activate` FOREIGN KEY (`d_ch_active`) REFERENCES `deliver_active` (`d_a_id`),
  ADD CONSTRAINT `fk_deliver` FOREIGN KEY (`deli_deliver_id`) REFERENCES `user` (`user_id`);

--
-- Constraints for table `order_product`
--
ALTER TABLE `order_product`
  ADD CONSTRAINT `fk_dc` FOREIGN KEY (`orp_dc`) REFERENCES `customer_deliver` (`cu_id`),
  ADD CONSTRAINT `fk_tracking` FOREIGN KEY (`orp_tr_id`) REFERENCES `tracking` (`tr_id`);

--
-- Constraints for table `tracking`
--
ALTER TABLE `tracking`
  ADD CONSTRAINT `fk_status` FOREIGN KEY (`ps_id`) REFERENCES `status_process` (`status_id`);
COMMIT;
