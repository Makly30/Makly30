...
<!-- <a href="graph_after_pay_deliver.php" class="btn btn-success mt-4">ยอดเงินที่เลือแต่ละวันหลังชำระค่าขนส่ง</a> -->
    <h2 class="text-danger text-center">ยอดเงินที่จ่ายให้บริการส่งในแต่ละวัน</h2>
   <div id="chart-container">
     <h5 class='text-info text-center'>X Axis เป็นวันที่จ่ายให้บริการส่ง, Y Axis เป็นจำนวนเงินที่จ่ายให้บริการส่งทั้งหมดในวันนั้น</h5>
        ...
        {
            {
                ...
                function (data)
                {
                    ...
                    var chartdata = {
                        ...
                        datasets: [
                            {
                                label: 'จำนวนเงินที่จ่ายให้บริการส่งเป็นบาท',
