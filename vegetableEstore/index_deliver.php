  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" href="index_deliver.php">Home</a>
        </li>
...
<div class='container'>
 ...
 <?php
include 'connectdb.php';
$sql="SELECT deliver_choices.d_ch_date,deliver_choices.deli_price,deliver_choices.d_ch_int,deliver_choices.deli_pic,deliver_choices.deli_avtime_to,deliver_choices.deli_avtime_from,user_username pk,p1.province_name ps, p2.province_name pt,deliver_choices.deli_time,deliver_choices.d_ch_active,deliver_choices.deli_start,deliver_choices.deli_stop from deliver_choices join user on deliver_choices.deli_deliver_id=user.user_id join deliver_active on deliver_choices.d_ch_active=deliver_active.d_a_id join province as p1 on deliver_choices.deli_start=p1.PROVINCE_ID join province as p2 on deliver_choices.deli_stop=p2.PROVINCE_ID where deliver_active.d_a_id=2;";
