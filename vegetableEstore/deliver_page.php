...
<!-- menubar -->
      ...
      <div class="row">
                ...
                <div class="col-4">
                    <div class="card  mb-2" style="width:350px">
                        <img class="card-img-top" src="<?php  echo $objResult["user_picture"];?>" alt="Card image" height="200">
                        <div class="card-body">
  ...
  <a href="photoshow_deliver_change.php?user_id=<?php echo $objResult['user_id'];?>" class="btn btn-info">เปลี่ยนภาพ</a>
