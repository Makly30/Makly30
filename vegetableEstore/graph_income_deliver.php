...
<!-- <a href="graph_after_pay_deliver.php" class="btn btn-success mt-4">ยอดเงินที่เลือแต่ละวันหลังชำระค่าขนส่ง</a> -->
    <h2 class="text-danger text-center">ยอดเงินที่ลูกค้าจ่ายบริการส่งในแต่ละวัน</h2>
   <div id="chart-container">
     <h5 class='text-info text-center'>X Axis เป็นวันที่, Y Axis เป็นจำนวนยอดเงินที่ลูกค้าจ่ายบริการส่งในแต่ละวัน</h5>
        ...
        {
            {
                ...
                function (data)
                {
                    ...
                    var chartdata = {
                        ...
                        datasets: [
                            {
                                label: 'จำนวนยอดเงินที่ลูกค้าจ่ายบริการส่งในแต่ละวัน (Baht)',
