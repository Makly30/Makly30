...
<?php
    include 'connectdb.php';
    $sql="SELECT d.dl_id, u.user_username,a.orp_id,d.dl_datetime, dc.deli_price, dc.deli_avtime_from, t.tr_id from deliver_list as d join user as u on d.dl_deli_id=u.user_id join order_product as a on d.dl_orp_id=a.orp_id join deliver_choices as dc on d.dl_dc_id=dc.d_ch_int join tracking as t on d.dl_id=t.tr_de_list_id join user as k on d.dl_s_id=k.user_id where k.user_id='".$objResult['user_id']."' order by d.dl_id;";
   ...
   <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Deliver Name</th>
                                <th>ราคา</th>
                                <th>เวลาorder service</th>
                                <th>รหัส Customer Order</th>
                                <th>Tracking Code</th>
                            </tr>                
                        </thead>
                        <tbody>
    ...
    while (($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) ) {
        ...
        echo '<td class="text-center">' . $row['orp_id'] . '</td>';
