    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item active" href="deliver_page.php">My Personal Info</a>
...
<a href="graph_all_data_deliver.php" class="btn btn-success mt-4">ยอดสรุปร่วม</a>

    <h2 class="text-danger text-center">ยอดสรุปร่วม</h2>
   <div id="chart-container">
     <h5 class='text-info text-center'>X Axis เป็นวันที่, Y Axis เป็นจำนวนยอดสรุปร่วมทั้งหมดในวันนั้น</h5>
        ...
        {
            {
                ...
                function (data)
                {
                    ...
                    for (var i in data) {
                        ...
                        marks.push(data[i].expense);
                    }
                    var chartdata = {
                        labels: name,
                        datasets: [
                            {
                                label: 'จำนวนยอดสรุปร่วมทั้งหมด(Baht)',
