...
<style>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="form-inline my-2 my-lg-1 col-md-6" action="result_vegetable.php">
      <input class="form-control mr-sm-2 col-5" type="search" name="search_vegetable"placeholder="ระบุุชื่อผัก หรือ จังหวัดที่ว่างขาย" aria-label="Search">
