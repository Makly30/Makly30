...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 14, 2021 at 01:56 PM
...
(1, 1, 2, 50, 1, '2021-08-06 15:19:22', 2),
(2, 1, 2, 52, 2, '2021-08-08 17:12:47', 1),
(3, 1, 2, 24, 3, '2021-08-14 04:11:13', 1),
(4, 1, 2, 15, 0, '2021-08-14 10:08:19', 2);
...
(4, 'Market002', 'Market', '002', '0660018286', 'Market002@vegetable.estore', 'ต บ้านระกาศ อ บางบ่อ จ สมุทปราการ', 'seller', '123', 'seller-woman-in-a-farmer-market-vector-26571266.jpg', 2, 53, '110202');
...
--
ALTER TABLE `deliver_choices`
  MODIFY `d_ch_int` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `order_product`
  MODIFY `orp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
