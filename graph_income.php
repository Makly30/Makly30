...
<!-- <a href="graph_after_pay_deliver.php" class="btn btn-success mt-4">ยอดเงินที่เลือแต่ละวันหลังชำระค่าขนส่ง</a> -->
    <h2 class="text-danger text-center">ยอดสรุปร่วมของค่าผัก</h2>
   <div id="chart-container">
     <h5 class='text-info text-center'>X Axis เป็นวันที่มีคนออเดอร์, Y Axis เป็นจำนวนเงินทั้งหมดในวันนั้น</h5>
