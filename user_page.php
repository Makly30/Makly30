...
<!-- menubar -->
      ...
      <div class="row">
                ...
                <div class="col-4">
                    <div class="card  mb-2">
                        <img class="card-img-top" src="<?php  echo $objResult["user_picture"];?>" alt="Card image">
                        <div class="card-body">
  ...
  <span class="label label-warning "><a class="btn btn-warning" href="edit_profile.php" >Edit Profile</a></span>
  <a href="photoshow_customer_change.php?user_id=<?php echo $objResult['user_id'];?>" class="btn btn-info">เปลี่ยนภาพ</a>
