...
<?php
    ...
    $myquery =  "SELECT round(sum(total_price),2)as total_price,DATE(orp_datetime) as timenew FROM `order_detail` where owner ='".$objResult['user_username']."' group by timenew";
